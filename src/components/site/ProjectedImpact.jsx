...
export default function ProjectedImpact() {
  return (
    <section id="impact" className="relative py-24 md:py-40 border-t border-border/60 bg-sage">
      <div className="max-w-7xl mx-auto px-6">
        <div className="bg-background rounded-[28px] px-6 py-12 md:px-12 md:py-14">
          <Reveal>
            <div className="font-mono-label text-primary mb-5">Projected Impact</div>
        ...
        <div className="mt-14 grid grid-cols-1 md:grid-cols-3 gap-6">
          {CARDS.map((c, i) => (
            <Reveal key={c.business} delay={i * 100}>
              <div className="card-hover relative flex flex-col h-full border border-border/60 rounded-2xl bg-khaki overflow-hidden">
                ...
                <div className="p-6 flex flex-col flex-1">
                  <div className="font-mono-label text-primary mb-2">
                    AUDIT PREVIEW
                  </div>
                  <h3 className="text-lg font-semibold tracking-tight mb-4 text-primary">
                    {c.business}
                  </h3>
                  <p className="text-primary text-sm leading-relaxed mb-6 flex-1">
                    {c.leak}
                  </p>

                  <div className="border-tb order-primary/15 pt-5 flex items-end gap-3">
                    {c.direction === "up" ? (
        ...
        <Reveal delay={120} className="mt-8">
          <p className="font-mono-label text-on-navy text-[11px]">
